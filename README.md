...
"Hello Microverse!" project is a repository consisting of two simple files:
- HTML file (index.html)
- CSS file (styles.css)

The project was designed in a professional way.
...
I would like to thank Microverse program for providing me with necessary template files and detailed instructions.
